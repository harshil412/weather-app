...
function Temperature({setCity, stats}) {
  ...
  return (
    ...
    <div className="flex justify-center text-slate-200 mt-8 items-center text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out">
